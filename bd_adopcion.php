...
function getJsonTweets($max_id,$fecha){
		...
		$query = 'mascota OR perro OR gato OR adopcion OR adoptar OR adopta adopta OR adopcion OR adoptar -mono -"adopta la forma" -"adopta forma" -"proyecto" -enfermedad -enfermedades -"habitossaludables" -rt -RT -"amigos por siempre" -ganadores   -venta -vender -JiaJia -donar -donacion -compra -comprar -niño -unete -niña -bebe -"no compres" -jornada -asiste';
